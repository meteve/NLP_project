...
Finally, we notice a strong heterogeneity between authors through the analysis of the confusion matrix, displayed in figure~\ref{conf_matrix}. CamemBERT well classified 49.6\% of Zola's paragraphs, whereas it well classified 90.1\% of Dumas's paragraphs. The gap is reduced when it comes to precision: 75.7\% of the predicted Zola are true Zola, and 76.3\% for Dumas. Dumas or Flaubert seem to be more easily identified than Daudet or Vigny. Some authors may have a more singular writing style than others, or simply reuse character and place names in several books.
